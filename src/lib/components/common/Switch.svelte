<script lang="ts">
    ...
    export let activeClass = 'bg-emerald-600';
    export let inactiveClass = 'bg-gray-200 dark:bg-transparent';
...
<Switch.Root
	...
	class="flex h-5 min-h-5 w-9 shrink-0 cursor-pointer items-center rounded-full px-[3px] mx-[1px] transition  {state
		? activeClass
		: inactiveClass} outline outline-1 outline-gray-100 dark:outline-gray-800"
>
	<Switch.Thumb
