...
from world_seek.env import SRC_LOG_LEVELS, PIP_OPTIONS, PIP_PACKAGE_INDEX_OPTIONS
from world_seek.models.functions import Functions
from world_seek.models.tools import Tools
...
def replace_imports(content):
    ...
    """
    replacements = {
        "from utils": "from world_seek.utils",
        "from apps": "from world_seek.apps",
        "from main": "from world_seek.main",
        "from config": "from world_seek.config",
    }
