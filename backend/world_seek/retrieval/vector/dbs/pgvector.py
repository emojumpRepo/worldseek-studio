...
from world_seek.retrieval.vector.main import VectorItem, SearchResult, GetResult
from world_seek.config import PGVECTOR_DB_URL, PGVECTOR_INITIALIZE_MAX_VECTOR_LENGTH
...
class PgvectorClient:
    def __init__(self) -> None:
        ...
        if not PGVECTOR_DB_URL:
            from world_seek.internal.db import Session
