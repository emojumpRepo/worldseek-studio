...
from world_seek.internal.db import Base, get_db
from world_seek.utils.redis import get_redis_connection
...
def run_migrations():
    ...
    try:
        ...
        alembic_cfg = Config(WORLD_SEEK_DIR / "alembic.ini")

        # Set the script location dynamically
        migrations_path = WORLD_SEEK_DIR / "migrations"
...
STATIC_DIR = Path(os.getenv("STATIC_DIR", WORLD_SEEK_DIR / "static")).resolve()
...
# FastGPT配置
FASTGPT_BASE_URL = "http://192.168.5.48:3001"
